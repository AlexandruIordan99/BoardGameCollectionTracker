package com.example.smallsocialnetwork.authentication;

import com.example.smallsocialnetwork.email.EmailService;
import com.example.smallsocialnetwork.email.EmailTemplateName;
import com.example.smallsocialnetwork.role.RoleRepository;
import com.example.smallsocialnetwork.security.JwtService;
import com.example.smallsocialnetwork.user.Token;
import com.example.smallsocialnetwork.user.TokenRepository;
...
public class AuthenticationService {
    ...
    public void activateAccount(String token) throws MessagingException {
        ...
        if(LocalDateTime.now().isAfter(savedToken.getExpiresAt())) {
            ...
            throw new RuntimeException("Activation token has expires." +
